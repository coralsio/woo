...
trait WooCommerceTrait
{
     ...
     *
     * @return Corals\Modules\Woo\Integration\WooCommerceCommerce\HttpClient\Request
     */
     ...
     *
     * @return Corals\Modules\Woo\Integration\WooCommerceCommerce\HttpClient\Response
     */
    ...
    public function countResults()
    {
        ...
        return $headers[strtoupper($this->headers['header_total'])];
    }
    ...
    public function countPages()
    {
        $headers = $this->getResponse()->getHeaders();
        $headers = array_change_key_case($headers, CASE_UPPER);
        return $headers[strtoupper($this->headers['header_total_pages'])];
    }
